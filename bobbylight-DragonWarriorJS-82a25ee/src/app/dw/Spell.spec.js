    ...
    describe('hurtSpell', () => {
        ...
        describe('when the caster is an Enemy', () => {
            ...
            it('returns the expected response', () => {
                ...
                expect((_a = result.conversationSegments) === null || _a === void 0 ? void 0 : _a.length).toEqual(1);
                expect((_b = result.conversationSegments) === null || _b === void 0 ? void 0 : _b[0].text).toMatch(/Thy Hit Points have been reduced by \d+./);
            });
        });
        describe('when the caster is a Hero', () => {
            it('lowers the target\'s hp', () => {
            ...
            it('returns the expected response', () => {
                ...
                expect(result.conversationSegments).toBeDefined();
                expect((_a = result.conversationSegments) === null || _a === void 0 ? void 0 : _a.length).toEqual(1);
                expect((_b = result.conversationSegments) === null || _b === void 0 ? void 0 : _b[0].text).toMatch(/The Slime's Hit Points have been reduced by \d+./);
            });
            it('returns the expected response when there is no target', () => {
                ...
                expect(result.conversationSegments).toBeDefined();
                expect((_a = result.conversationSegments) === null || _a === void 0 ? void 0 : _a.length).toEqual(1);
                expect((_b = result.conversationSegments) === null || _b === void 0 ? void 0 : _b[0].text).toEqual('But nothing happened.');
            });
        });
    });
});
//# sourceMappingURL=Spell.spec.js.map