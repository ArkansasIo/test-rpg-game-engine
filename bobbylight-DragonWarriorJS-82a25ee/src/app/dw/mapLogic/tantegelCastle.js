...
const talks = {
    south_soldier_left: (game) => {
        return 'Welcome to Tantegel Castle.';
    },
    south_soldier_right: (game) => {
        return 'Welcome to Tantegel Castle.';
    },
    bottom_left_merchant_1: (game) => {
...
//# sourceMappingURL=tantegelCastle.js.map