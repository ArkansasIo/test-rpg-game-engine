 ...
 */
export const getChestConversation = (state) => {
    const game = state.game;
    const location = toLocationString(game.hero.mapRow, game.hero.mapCol);
    const chest = game.getMap().chests.get(location);
    const conversation = new Conversation(game, false);
    if (!chest) {
...
//# sourceMappingURL=ChestConversations.js.map