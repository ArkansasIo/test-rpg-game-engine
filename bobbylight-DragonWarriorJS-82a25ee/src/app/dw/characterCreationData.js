...
export const toPortraitToken = (value) => value.toUpperCase().replace(/[^A-Z0-9]+/g, '_').replace(/^_+|_+$/g, '');
export const toCharacterPortraitId = (...parts) => `CHAR__${parts.map(toPortraitToken).join('__')}`;
//# sourceMappingURL=characterCreationData.js.map