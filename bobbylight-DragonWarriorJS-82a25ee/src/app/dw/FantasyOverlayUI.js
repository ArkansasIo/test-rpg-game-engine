...
export function drawFantasyBackdrop(ctx, width, height) {
...
export function drawFantasyPanel(ctx, x, y, width, height, title) {
...
export function drawPane(ctx, x, y, width, height, title) {
...
export function drawTabStrip(ctx, x, y, labels, selected) {
    let ox = x;
    ctx.font = 'bold 12px Georgia';
...
export function drawMenuChrome(ctx, labels, activeLabel, width) {
...
export function drawFantasyLine(ctx, text, x, y, selected = false, tone = 'normal') {
    if (selected) {
...
//# sourceMappingURL=FantasyOverlayUI.js.map