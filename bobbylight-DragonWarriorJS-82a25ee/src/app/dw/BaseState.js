import { ImageUtils, Keys, State } from 'gtp';
/**
...
export class BaseState extends State {
    ...
    createScreenshot() {
        const canvas = ImageUtils.createCanvas(this.game.getWidth(), this.game.getHeight());
    ...
    static handleCanvasResizingKeys(im, canvas, game) {
