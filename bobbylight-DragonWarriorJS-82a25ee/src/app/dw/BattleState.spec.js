    ...
    describe('run()', () => {
        describe('when the run attempt fails', () => {
            ...
            beforeEach(() => {
                ...
                vi.spyOn(textBubble, 'onDone').mockImplementation((cb) => {
                    cb();
                });
            ...
            it('prints that the hero runs away', () => {
                expect(addToConversationSpy).toHaveBeenCalledWith({ text: 'Erdrick started to run away.' }, true);
...
//# sourceMappingURL=BattleState.spec.js.map