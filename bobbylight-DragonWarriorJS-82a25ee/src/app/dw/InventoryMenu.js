import { nesTheme, drawNesPanel } from '../gfx/Theme';
export class InventoryMenu {
    ...
    render(ctx) {
        ...
        if (!this.items.length) {
            ...
            ctx.fillStyle = nesTheme.panelAccent;
            ctx.fillText((_a = selected === null || selected === void 0 ? void 0 : selected.displayName) !== null && _a !== void 0 ? _a : '', rightX, panelY + 120);
            ctx.fillStyle = nesTheme.text;
    ...
    handleClick(x, y) {
        ...
        if (idx >= 0 && idx < this.items.length) {
            ...
            const selected = this.items[this.selectedIndex];
            this.game.setStatusMessage(`Selected item: ${(_a = selected === null || selected === void 0 ? void 0 : selected.displayName) !== null && _a !== void 0 ? _a : ''}`);
        }
    }
}
