 ...
 */
export const createNewAdventureLog = () => {
 ...
 */
export const loadAdventureLog = (id) => {
    if (id) {
 ...
 */
export const getAdventureLogSummaries = () => {
    const json = localStorage.getItem(INDEX_KEY);
    return json ? JSON.parse(json) : [];
};
//# sourceMappingURL=AdventureLog.js.map