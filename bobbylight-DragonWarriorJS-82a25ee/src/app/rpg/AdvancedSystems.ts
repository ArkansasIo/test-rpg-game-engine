import { StatModifiers, AbilityDef } from './RPGCoreTypes';
...
export interface SkillTreeNode {
  ...
  parentId?: string;
  ability?: AbilityDef;
  statBonus?: StatModifiers;
  children?: SkillTreeNode[];
}

export const warriorSkillTree: SkillTreeNode[] = [
    {
        id: 'root',
...
// Example advanced system: procedural loot affix
